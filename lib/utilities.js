...
export function generateContentDirectory(elem, path, files, keepSearch=false){
    if (!keepSearch){
        ...
        $(elem + ' .nav-bg').append(`<div class="d-flex justify-content-between" style="cursor:pointer;" data-toggle="collapse" href="#collapseHelpSidebar" role="button" aria-expanded="false" aria-controls="collapseHelpSidebar"><b><i class="fas fa-question-circle"></i> How to use this site</b><i class="fas fa-chevron-down p-2"></i></div>`);
        $(elem + ' .nav-bg').append(`<div class="collapse pt-3" id="collapseHelpSidebar"></div>`);
        $(elem + ' .nav-bg .collapse').append(`<p>This site works like a file system, allowing you to navigate through all files and folders that make up the website.</p>`)
        ...
        $(elem + ' .col-xl-4').append(`<div class="nav-bg mb-3 p-3"></div>`);
        $(elem + ' .nav-bg:nth-child(2)').append(`<div class="d-flex justify-content-between" style="cursor:pointer;" data-toggle="collapse" href="#collapseDirectorySearch" role="button" aria-expanded="false" aria-controls="collapseDirectorySearch"><b><i class="fas fa-filter"></i> Filter results</b><i class="fas fa-chevron-down p-2"></i></div>`);
        $(elem + ' .nav-bg:nth-child(2)').append(`<div class="collapse show pt-3" id="collapseDirectorySearch"></div>`);
...
export function generateContentFile(elem, content, file){
    ...
    if (file['_type'] == 'md'){
        ...
        $(elem + ' .nav-bg').append(`<div class="d-flex justify-content-between" style="cursor:pointer;" data-toggle="collapse" href="#collapseHelpSidebar" role="button" aria-expanded="false" aria-controls="collapseHelpSidebar"><b><i class="fas fa-stream"></i> Page Contents</b><i class="fas fa-chevron-down p-2"></i></div>`);
        $(elem + ' .nav-bg').append(`<div class="collapse show pt-2" id="collapseHelpSidebar"><ul class="pl-1"></ul></div>`);
